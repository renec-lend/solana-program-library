...
pub enum LendingError {
    ...
    //65
    /// Invalid Renec Oracle Account
    #[error("Invalid Renec Oracle Account")]
    InvalidRenecOracleAccount,
    /// Voucher is not owned by VoucherProgram
    #[error("Voucher is not owned by VoucherProgram")]
    InvalidVoucherProgramOwner,
    /// Voucher discriminator is not match
    #[error("Voucher discriminator is not match")]
    InvalidVoucherDiscriminator,
    /// Voucher authority is not valid
    #[error("Voucher authority is invalid")]
    InvalidVoucherAuthority,
    /// Voucher discriminator is not match
    #[error("Voucher not applicable for token")]
    InvalidVoucherEligibleToken,

    // 70
    /// Voucher discriminator time is not valid
    #[error("Voucher is not applicable for this time")]
    InvalidVoucherTimeRange,
    /// Voucher market is not match
    #[error("Voucher market is not match")]
    InvalidVoucherMarket,
}
