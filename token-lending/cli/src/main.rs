...
fn main() {
            ...
            SubCommand::with_name("create-market")
                ...
                .arg(
                    Arg::with_name("switchboard_oracle_program_id")
                        ...
                        .takes_value(true)
                        .required(true)
                        .default_value(SWITCHBOARD_PROGRAM_ID)
            ...
            SubCommand::with_name("add-reserve")
                ...
                .arg(
                    Arg::with_name("extra_oracle_pubkey")
                        ...
                        .takes_value(true)
                        .required(false)
                        .help("Extra oracle. Only used to limit borrows and withdrawals"),
                )
                .arg(
                    Arg::with_name("attributed_borrow_limit_open")
                        ...
                        .required(true)
                        .default_value("0")
                        .help("Attributed borrow limit open"),
                )
                .arg(
                    Arg::with_name("attributed_borrow_limit_close")
                        ...
                        .required(true)
                        .default_value("0")
                        .help("Attributed borrow limit close"),
                )
                .arg(
    ...
    let _ = match matches.subcommand() {
        ...
        ("add-reserve", Some(arg_matches)) => {
            ...
            let extra_oracle_pubkey: Option<Pubkey> = pubkey_of(arg_matches, "extra_oracle_pubkey");
            ...
            command_add_reserve(
                ...
                ReserveConfig {
                    ...
                    extra_oracle_pubkey: extra_oracle_pubkey,
...
fn command_liquidate_obligation(
    ...
    //         reserve.liquidity.pyth_product_pubkey,
